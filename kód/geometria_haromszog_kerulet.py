...
def haromszogkerulet(masterwindow):
    def calc(*args):
        a = alengthscan.get()
        b = blengthscan.get()
        c = clengthscan.get()
    ...
    haromszogk = Toplevel(masterwindow, height=400, width=600)
    haromszogk.title("Python SPAR projekt")
    haromszogk.minsize(width = 600, height = 400)
    haromszogk.maxsize(width = 600, height = 400)
    selection = IntVar()
    selection.set(1)
    alengthscan = StringVar()
    blengthscan = StringVar()
    clengthscan = StringVar()
    menusor = Frame(haromszogk, width=600, height=400, bd=10, highlightbackground="green", highlightthickness=10)
    ...
    textbox = Label(haromszogk, text="Háromszög Kerület", fg="green")
    a = Label(haromszogk, text="a", fg="green")
    alength = Entry(haromszogk, textvariable=alengthscan, width=35)
    alength.focus()
    b = Label(haromszogk, text="b", fg="green")
    blength = Entry(haromszogk, textvariable=blengthscan, width=35)
    c = Label(haromszogk, text="c", fg="green")
    clength = Entry(haromszogk, textvariable=clengthscan, width=35)
    alengthscan.trace_add("write", calc)
    blengthscan.trace_add("write", calc)
    clengthscan.trace_add("write", calc)
    results = Entry(haromszogk, width=35)
    resulttext = Label(haromszogk, text="Eredmény:", fg="green")
